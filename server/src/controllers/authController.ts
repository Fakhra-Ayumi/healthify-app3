...
export const updateProfile = async (req: AuthRequest, res: Response) => {
  try {
    ...
    if (
      req.body.weeklyGoalStatus === "completed" &&
      currentUser.weeklyGoalStatus !== "completed"
    ) {
      incWeekly = 1;
    }
    if (
      req.body.threeMonthGoalStatus === "completed" &&
      currentUser.threeMonthGoalStatus !== "completed"
    ) {
      incThreeMonth = 1;
    }
    ...
    const settableFields = [
      ...
      "purpose",
      "threeMonthGoal",
      "threeMonthGoalStatus",
      "weeklyGoal",
      "weeklyGoalStatus",
      "weeklyGoalLockIn",
      "threeMonthGoalLockIn",
      "streakGoal",
      "currentStreak",
      "profileImage",
      "badges",
    ...
    // Fallback if update fails/returns null (should not happen with findByIdAndUpdate success)
